  ...
  return (
    <div className="bg-whiteSmoke dark:bg-white font-Inter">
      <div className="relative">
        ...
        {/* ===== BOOKING SECTION ===== */}
        <div className="Container-Hero bg-lightBlack dark:bg-normalBlack grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 
                        items-center justify-center font-Arial py-3 lg:py-4 xl:py-5 border-t-[3px]
                        border-t-khaki mx-auto shadow-xl relative z-20 -mt-20 px-4 sm:px-6 lg:px-10"
        >
          ...
          <div className="p-3">
            ...
            <button
              type="button"
              onClick={openInOverlay}
              className="flex items-center justify-between w-full text-left text-white text-sm
                         lg:text-base border border-white/20 px-3 py-2 mt-[2px]"
            >
            ...
            {open && (
              <div className="absolute bg-white text-black w-60 mt-2 shadow-lg z-20 py-2">
                <div className="px-5 py-2 flex justify-between items-center">
                  <div>{room} Room</div>
                  <div className="flex gap-2">
                    <button className="w-5 h-5 bg-khaki text-white" onClick={() => setRoom(room + 1)}>+</button>
                    <button className="w-5 h-5 bg-khaki text-white" onClick={() => setRoom(Math.max(1, room - 1))}>-</button>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="absolute bg-white text-black w-60 mt-2 shadow-lg z-20 py-2">
                ...
                <div className="px-5 py-2 flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="w-5 h-5 bg-khaki text-white" onClick={() => setAdult(Math.max(1, adult - 1))}>-</button>
                  </div>
                </div>
                ...
                <div className="px-5 py-2 flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="w-5 h-5 bg-khaki text-white" onClick={() => setChildren(Math.max(0, children - 1))}>-</button>
                  </div>
                </div>
          ...
          <Link
            ...
            className="col-span-2 md:col-span-1"
          >
            <button className="w-full h-10 lg:h-[50px] text-[15px] bg-khaki border border-khaki text-white hover:bg-opacity-90">
              Check Availability
            </button>
          </Link>
        </div>

        {/* ===== WHITE SIMPLE CALENDAR POPUP ===== */}
        {(showInOverlay || showOutOverlay) && (
          ...
          >
            <div
              className="bg-white text-black shadow-2xl max-w-[560px] w-full"
              onClick={(e) => e.stopPropagation()}
            >
        ...
        {/* ===== ROOMS SECTION ===== */}
        <section
          className="relative w-full overflow-hidden mt-[-163px] md:mt-[-135px] lg:mt-[-143px]
                     xl:mt-[-57px] h-[880px] lg:h-[700px]"
        >
          <div className="absolute inset-0 grid grid-cols-1 lg:grid-cols-2 h-full">
            ...
            {rooms.map((r) => {
              ...
              return (
                <div key={r._id} className="relative group overflow-hidden">
                  <div
                  ...
                  <div className="absolute left-0 right-0 bottom-0 m-6">
                    <div className="text-center translate-y-[200px] group-hover:translate-y-0 
                                    opacity-0 group-hover:opacity-100 transition-all duration-500">

                      <Link
                        to={`/room_details2/${r._id}`}
                        className="w-[50px] h-[50px] rounded-full bg-white mb-6 grid
                                   place-items-center mx-auto hover:scale-105"
                      >
                        <AiOutlineEye size={20} className="text-[#006600]" />
                      </Link>

                      <div className="bg-white text-center py-10">
                        <h4 className="text-lg md:text-xl lg:text-2xl">{r.roomType}</h4>
